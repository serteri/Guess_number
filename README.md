...
I am trying to desing a guess number game.In the beginning computer choose a number between 1234 and 9876 because all digits must be different. And you try to guess the number. For example computer chose 1234 and you guessed 1456 ,output would be +1 ,-1 because you did guess correct two number but one of them is in the correct position and the other is not.
...
![Not digit](./src/docs/screen%20shots/part_2.png)

If user enter a number that length is not 4,it will give you an error.

![Not for digit](./src/docs/screen%20shots/part_3.png)

If the guess starts with 0, again it will give you length error.

![First Digit 0](./src/docs/screen%20shots/part_4.png)

If there is a repeating number ,it gives an error.

![Repeating digit](./src/docs/screen%20shots/part_5.png)

If gues number is passed all parts above, guess comparing parts begins.

![Guessing part](./src/docs/screen%20shots/part_6.png)

![Guessing part](./src/docs/screen%20shots/part_7.png)
![Guessing part](./src/docs/screen%20shots/part_8.png)

If you guess the number correctly, the game asks you for another game and store your point.

![Guess correctly](./src/docs/screen%20shots/part_9.png)

If your answer is y, new game starts.

![New game](./src/docs/screen%20shots/part_10.png)
...
![End game](./src/docs/screen%20shots/part_11.png)

# Design Process

- First step: I developed class Player to store player names and scores. Initial score is 0

![Player Class](./src/docs/screen%20shots/player_class.png)
...
- Second step: I created Number class to store all numbering functions.
  ...
  ![Class Number](./src/docs/screen%20shots/random_number.png)

* In Number Class I created main function for the game: Number checking.This is the last state for the function:

![number checking](./src/docs/screen%20shots/num_check1.png)
![nember checking](./src/docs/screen%20shots/num_check3.png)
![number checking](./src/docs/screen%20shots/num_check3.png)
...
![different ](./src/docs/screen%20shots/different_digits.png)
...
![count variable](./src/docs/screen%20shots/count_variable.png)

- After count variable returns, player point is updated. And Display point with the player name.Code as follows:

![player point](./src/docs/screen%20shots/point_updated.png)
...
![json updated](./src/docs/screen%20shots/json_csv_update.png)

- It is a json file update function.

![json file update function](./src/docs/screen%20shots/json_update.png)

- Csv update function is below:

![csv update function](./src/docs/screen%20shots/csv_update.png)

- After this steps,new_game variable creating with input New game:Y/N
  If yes, game start again
  If no,printThanks for playing

![new game](./src/docs/screen%20shots/new_game.png)

- Timer function is working to calculate how long took for the game.

![timer function](./src/docs/screen%20shots/game_timing.png)

- At the end of the game, top three players are shown:

![top three players](./src/docs/screen%20shots/top_players.png)
...
![guess check](./src/docs/screen%20shots/check_first_guess.png)
...
![not first guess](./src/docs/screen%20shots/else_first_check.png)

After this check, program will check the user guess and computer number.

![after first guess](./src/docs/screen%20shots/check_num%20ersss.png)

if it is not a valid number,it will give an error

![not valid](./src/docs/screen%20shots/error%2B_else.png)
...
![json update](./src/docs/screen%20shots/json_update.png)

Json file example:

![json file example](./src/docs/screen%20shots/json_file.png)
...
![top players](./src/docs/screen%20shots/top_players.png)

# Logic diagram

I add the logic diagram of the program.

![logic of the game](./src/docs/diagram/Guess_Number.png)
